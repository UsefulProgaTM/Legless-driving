...
public class Outline : MonoBehaviour, ISelectable{
  ...
  private float outlineWidth = 5f;
    ...
    private float defaultOutlineWidth = 0;
    private float selectedOutlineWidth = 0;
  ...
  void Awake() {
    ...
    selectedOutlineWidth = outlineWidth;
    ...
    {
        outlineWidth = hit ? selectedOutlineWidth : defaultOutlineWidth;
        needsUpdate = true;
    }
